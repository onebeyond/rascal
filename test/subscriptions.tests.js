...
describe('Subscriptions', () => {
  ...
  it('should symmetrically decrypt messages', (test, done) => {
    createBroker(
      {
        vhosts,
        publications: {
  ...
  it('should emit an error event when the broker cancels the consumer and there is no cancel handler', (test, done) => {
    createBroker(
      {
        vhosts,
        publications,
