...
module.exports = _.curry(function(config, next) {
    ...
    function validateExchange(vhost, vhostName, exchange, exchangeName) {
        validateVhostChildAttributes(vhostName, 'Exchange', exchange, exchangeName, ['fullyQualifiedName', 'name', 'assert', 'check', 'type', 'unique', 'options'])
    }
    ...
    function validateQueue(vhost, vhostName, queue, queueName) {
        validateVhostChildAttributes(vhostName, 'Queue', queue, queueName, ['fullyQualifiedName', 'name', 'assert', 'check', 'type', 'purge', 'unique', 'options'])
    }
