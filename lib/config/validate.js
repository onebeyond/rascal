...
module.exports = _.curry(function(config, next) {
  ...
  function validateVhost(vhost, vhostName) {
    validateAttributes('Vhost', vhost, vhostName, ['defaults', 'namespace', 'name', 'publicationChannelPools', 'connection', 'connections', 'exchanges', 'queues', 'bindings'])
  ...
  function validatePublicationChannelPools(publicationChannelPools, vhostName) {
    var invalid = _.chain(publicationChannelPools).omit(['regularPoolSize', 'confirmPoolSize']).keys().value()
  ...
  function validatePublication(publication, publicationName) {
    validateAttributes('Publication', publication, publicationName, ['name', 'vhost', 'exchange', 'queue', 'routingKey', 'confirm', 'options', 'destination', 'autoCreated', 'deprecated'])
  ...
  function validateSubscription(subscription, subscriptionName) {
    validateAttributes('Subscription', subscription, subscriptionName, ['name', 'vhost', 'queue', 'contentType', 'options', 'prefetch', 'retry', 'source', 'recovery', 'workflow', 'handler', 'workflows', 'handlers', 'redeliveries', 'autoCreated', 'deprecated', 'deferCloseChannel'])
