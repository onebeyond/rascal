...
function bindQueue(config, channel, binding, next) {
    ...
    debug(format('Binding queue: %s to exchange: %s with binding key: %s', destination.fullyQualifiedName, source.fullyQualifiedName, binding.bindingKey))
...
function bindExchange(config, channel, binding, next) {
    ...
    debug(format('Binding exchange: %s to exchange: %s with binding key: %s', destination.fullyQualifiedName, source.fullyQualifiedName, binding.bindingKey))
