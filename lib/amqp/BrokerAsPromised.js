...
module.exports = {
  create() {
    ...
    return new Promise(function(resolve, reject) {
      Broker.create(...args.concat(function(err, broker) {
...
function BrokerAsPromised(broker) {
  ...
  _.each(methods, function(method) {
    self[method] = function() {
      const args = Array.prototype.slice.call(arguments);
      return new Promise(function(resolve, reject) {
        broker[method](...args.concat(function(err, result) {
  ...
  this.subscribe = function() {
    const args = Array.prototype.slice.call(arguments);
    return new Promise(function(resolve, reject) {
      broker.subscribe(...args.concat(function(err, session) {
        if (err) return reject(err);
  ...
  this.subscribeAll = function() {
    const args = Array.prototype.slice.call(arguments);
    return new Promise(function(resolve, reject) {
      broker.subscribeAll(...args.concat(function(err, sessions) {
        if (err) return reject(err);
