...
function unqualifiedNameWarning(type, unqualifiedName, vhost) {
    ...
    console.warn(format('Unqualified %s have been deprecated and will be removed in the next major version of rascal. Instead of %s use %s. See https://github.com/guidesmiths/rascal/issues/20', type, unqualifiedName, qualifiedName))
}
